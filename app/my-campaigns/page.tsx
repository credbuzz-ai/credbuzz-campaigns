        ...
        {user && (
          <div className="">
            <div className="flex flex-col lg:flex-row justify-between gap-6 items-start mb-6">
                      ...
                      >
                        ...
                        <AccordionItem value="item-1" className="border-none">
                          ...
                          <AccordionContent className="text-[#CFCFCF] text-sm">
                            ...
                            that resonates with the crypto Twitter (CT)
                            community about projects that have active campaigns.
                          </AccordionContent>
                        </AccordionItem>
              ...
              <div className="flex flex-col gap-2 items-start w-60 max-w-md">
                {user.evm_wallet && (
                  <div className="flex items-center justify-between w-full p-1 rounded-lg bg-gray-800/50 border border-gray-700">
                    ...
                    <button
                      onClick={() => {
                        ...
                        toast({
                          title: "Address copied!",
                          description:
                            "Celo wallet address copied to clipboard",
                          duration: 2000,
                        });
                      }}
                      className="p-2 hover:bg-gray-700 rounded-lg transition-colors"
